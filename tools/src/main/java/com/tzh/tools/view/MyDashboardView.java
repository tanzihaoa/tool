...
import com.anderson.dashboardview.view.DashboardViewAttr;
...
public class MyDashboardView extends View {
    ...
    private void initPaint() {
        ...
        paintProgressBackground.setColor(Color.parseColor("#ffffff"));
        ...
        paintNum.setColor(Color.parseColor("#B8BED5"));
    ...
    private void setAnimator(final float percent) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                MyDashboardView.this.percent = (float) animation.getAnimatedValue();
                invalidate();
        ...
        valueAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                //防止因为插值器误差产生越界
                if (MyDashboardView.this.percent < 0.0) {
                    MyDashboardView.this.percent = 0.0f;
                    invalidate();
                }
                if (MyDashboardView.this.percent > 100.0) {
                    MyDashboardView.this.percent = 100.0f;
                    invalidate();
                }
            }
        });

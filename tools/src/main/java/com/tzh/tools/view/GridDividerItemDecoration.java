...
/**
 * Created by e-boy on 2019/08/29 .
 */
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridDividerItemDecoration(int width, int height, @ColorInt int color, boolean showFirstDivider) {
        mDividerWidth = width;
        mDividerHeight = height;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        // 以 6列为例(spanCount==6), 每个item左右裁切为 (0,5)(1,4)(2,3)(3,2)(4,1)(5,0)
        int relativePos = itemPosition % spanCount;
        int left = relativePos * mDividerWidth / spanCount;
        int right = (spanCount - 1 - relativePos) * mDividerWidth / spanCount;
        int bottom = isLastRow ? 0 : mDividerHeight; // 如果是最后一行，则不需要绘制底部
        int top = isFirstRow(parent, itemPosition, spanCount, childCount) && mShowFirstDivider ? mDividerHeight : 0;

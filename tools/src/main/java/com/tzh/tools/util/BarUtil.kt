...
object BarUtil {
    ...
    fun setStatusBarView(view: View) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M && bgColor != Color.TRANSPARENT) {
            view.setBackgroundColor(com.tzh.tools.Tools.app.resources.getColor(R.color.colorPrimary))
        } else {
...
///////////////////////////////////////////////////////////////////////////
    ...
    fun getActionBarHeight(): Int {
        val tv = TypedValue()
        return if (com.tzh.tools.Tools.app.theme.resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            TypedValue.complexToDimensionPixelSize(
                tv.data, com.tzh.tools.Tools.app.resources.displayMetrics
            )
        } else 0
    }
...
///////////////////////////////////////////////////////////////////////////
    ...
    private fun invokePanels(methodName: String) {
        try {
            ...
            val service = com.tzh.tools.Tools.app.getSystemService("statusbar")
...
///////////////////////////////////////////////////////////////////////////
    ...
    fun setNavBarVisibility(@NonNull window: Window, isVisible: Boolean) {
        ...
        while (i < count) {
            ...
            val id = child.id
            if (id != View.NO_ID) {
                val resourceEntryName = com.tzh.tools.Tools.app
                    .resources
    ...
    fun isSupportNavBar(): Boolean {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            val wm = com.tzh.tools.Tools.app.getSystemService(Context.WINDOW_SERVICE) as WindowManager
        ...
        val menu = ViewConfiguration.get(com.tzh.tools.Tools.app).hasPermanentMenuKey()
